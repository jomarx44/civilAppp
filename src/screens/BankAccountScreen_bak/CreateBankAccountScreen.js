...
export const CreateBankAccountScreen = ({
  ...
  useEffect(() => {
    if (
      lists.homeOwnership.length <= 0 ||
      lists.civilStatus.length <= 0 ||
      lists.idList.length <= 0 ||
      lists.jobTitle.length <= 0 ||
      lists.nationality.length <= 0 ||
      lists.sourceOfFund.length <= 0
    ) {
      setTimeout(() => {
        getLists();
        setFetch(true);
...
const mapStateToProps = (state) => {
  ...
  return {
    ...
    lists: {
      ...
      homeOwnership: Object.values(homeOwnership.data),
      civilStatus: Object.values(civilStatus.data),
      idList: Object.values(idList.data),
      jobTitle: Object.values(jobTitle.data),
      nationality: Object.values(nationality.data),
      sourceOfFund: Object.values(sourceOfFund.data),
