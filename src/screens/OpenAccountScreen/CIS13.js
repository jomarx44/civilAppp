...
import PNRadioFormAccountType from "library/components/PNRadioFormAccountType"
      ...
      <Container>
        <KeyboardShift>
          ...
          onChangeText={(text) => this.onChangeText(text,"account_type")}/>*/}
              ...
              <View style={{flex: 1}} >
                <PNBlueButtonSaveAsyncStorage title="NEXT" navid="CIS14" storeKey="cis13" storeValue={this.state.cis}/>
              </View>
            </ScrollView>
          </View>
          )}
