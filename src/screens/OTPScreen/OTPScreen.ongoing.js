  ...
  handlePressDigit = value => {
    ...
    if (counter == 7) {
      ...
      this.props.verifyOTP_TM({
        ...
        otp,
        navid: this.props.navigation.getParam('navid') ? this.props.navigation.getParam('navid') : '',
        message: this.props.navigation.getParam('message') ? this.props.navigation.getParam('message') : '',
      });
    }
  };
